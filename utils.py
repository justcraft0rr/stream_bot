...
# Replace "YOUR_CHANNEL_NAME" With your youtube channel name
...
class Chat(twitchcommands.Bot):
    def __init__(self):
        super().__init__(
            ...
            initial_channels=["YOUR_TWITCH_CHANNEL_NAME"]
        )
    ...
    async def event_message(self, message):
        ...
        if user.lower() == "justcraft_twitchy":
    ...
    async def send_message(self, text: str):
        channel = self.get_channel(youtube_channel_name)
        if channel:
