...
```typescript
import { PipedreamClient, PipedreamEnvironment } from "@pipedream/sdk";
...
```typescript
import { AppCategoriesClient } from '@pipedream/sdk/appCategories';

const client = new AppCategoriesClient({...});
```
