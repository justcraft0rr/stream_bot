...
class WorkflowsClient {
    constructor(_options) {
        ...
        this.workflowDomain = (_a = _options.workflowDomain) !== null && _a !== void 0 ? _a : this._defaultWorkflowDomain;
    }
    get _defaultWorkflowDomain() {
     ...
     */
    invoke(request, authType = Pipedream.HTTPAuthType.None, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__invoke(request, authType, requestOptions));
    }
    __invoke(request_1) {
        return __awaiter(this, arguments, void 0, function* (request, authType = Pipedream.HTTPAuthType.None, requestOptions) {
            var _a;
            ...
            switch (authType) {
                ...
                case Pipedream.HTTPAuthType.OAuth:
                    authHeader = yield this._getAuthorizationHeader();
                    break;
                default:
                    break;
            }
            const _response = yield core.fetcher({
                ...
                headers: (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)({
                    Authorization: authHeader,
                    "x-pd-environment": requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.projectEnvironment,
     ...
     *     })
     */
    invokeForExternalUser(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__invokeForExternalUser(request, requestOptions));
    }
    __invokeForExternalUser(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            const { urlOrEndpoint, externalUserId, body, method, headers = {} } = request;
            if (!(externalUserId === null || externalUserId === void 0 ? void 0 : externalUserId.trim())) {
                throw new Error("External user ID is required");
            }
            if (!urlOrEndpoint.trim()) {
                throw new Error("Workflow URL or endpoint ID is required");
            }
            const authHeader = yield this._getAuthorizationHeader();
            if (!authHeader) {
                throw new Error("OAuth or token is required for invoking workflows for external users. Please pass credentials for a valid OAuth client");
            }
            ...
            return this.__invoke({
                ...
                body,
                method,
                headers: Object.assign(Object.assign({}, headers), { "X-PD-External-User-ID": externalUserId }),
            }, Pipedream.HTTPAuthType.OAuth, requestOptions);
        });
    }
    /**
    ...
    _buildWorkflowUrl(input) {
        ...
        if (isUrl) {
            ...
            if (!/^e(n|o)[a-z0-9-]+$/i.test(sanitizedInput)) {
                throw new Error(`Invalid endpoint ID format. Must contain only letters, numbers, and hyphens, and start with either "en" or "eo".`);
            }
