...
class TokensClient {
    ...
    __create(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_e = (_d = (yield core.Supplier.get(this._options.baseUrl))) !== null && _d !== void 0 ? _d : (yield core.Supplier.get(this._options.environment))) !== null && _e !== void 0 ? _e : environments.PipedreamEnvironment.Prod, `v1/connect/${core.url.encodePathParam(this._options.projectId)}/tokens`),
                method: "POST",
                headers: _headers,
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/connect/{project_id}/tokens");
        });
    }
    /**
     ...
     *     })
     */
    validate(ctok, request = {}, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__validate(ctok, request, requestOptions));
    }
    __validate(ctok_1) {
        return __awaiter(this, arguments, void 0, function* (ctok, request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_e = (_d = (yield core.Supplier.get(this._options.baseUrl))) !== null && _d !== void 0 ? _d : (yield core.Supplier.get(this._options.environment))) !== null && _e !== void 0 ? _e : environments.PipedreamEnvironment.Prod, `v1/connect/tokens/${core.url.encodePathParam(serializers.ConnectToken.jsonOrThrow(ctok, { omitUndefined: true }))}/validate`),
                method: "GET",
                headers: _headers,
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/connect/tokens/{ctok}/validate");
        });
    }
}
