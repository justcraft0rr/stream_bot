...
export declare class WorkflowsClient {
    ...
    private readonly workflowDomain;
    constructor(_options: WorkflowsClient.Options);
    private get _defaultWorkflowDomain();
    private get _urlProtocol();
    /**
     ...
     */
    invoke(request: Pipedream.InvokeWorkflowOpts, authType?: Pipedream.HTTPAuthType, requestOptions?: WorkflowsClient.RequestOptions): core.HttpResponsePromise<unknown>;
    private __invoke;
    /**
     ...
     *     })
     */
    invokeForExternalUser(request: Pipedream.InvokeWorkflowForExternalUserOpts, requestOptions?: WorkflowsClient.RequestOptions): core.HttpResponsePromise<unknown>;
    private __invokeForExternalUser;
    /**
