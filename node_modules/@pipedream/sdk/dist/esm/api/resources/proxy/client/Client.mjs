...
import { base64Encode } from "../../../../core/index.mjs";
import { createRequestUrl } from "../../../../core/fetcher/createRequestUrl.mjs";
...
export class ProxyClient {
     ...
     */
    getResponseType(headers) {
        const acceptHeader = headers === null || headers === void 0 ? void 0 : headers["x-pd-proxy-accept"];
        if (!acceptHeader) {
            return undefined; // No Accept header = default to JSON
        }
        const acceptValue = typeof acceptHeader === "string" ? acceptHeader : String(acceptHeader !== null && acceptHeader !== void 0 ? acceptHeader : "");
    ...
    __get(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }), transformedHeaders, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const responseType = this.getResponseType(_headers);
            const _response = yield core.fetcher({
                url: core.url.join((_e = (_d = (yield core.Supplier.get(this._options.baseUrl))) !== null && _d !== void 0 ? _d : (yield core.Supplier.get(this._options.environment))) !== null && _e !== void 0 ? _e : environments.PipedreamEnvironment.Prod, `v1/connect/${encodeURIComponent(this._options.projectId)}/proxy/${encodeURIComponent(url64)}`),
                method: "GET",
                headers: _headers,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.PipedreamTimeoutError("Timeout exceeded when calling GET /v1/connect/{project_id}/proxy/{url_64}.");
                case "body-is-null":
                    throw new errors.PipedreamError({
                        statusCode: _response.error.statusCode,
                        rawResponse: _response.rawResponse,
    ...
    __post(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.PipedreamTimeoutError("Timeout exceeded when calling POST /v1/connect/{project_id}/proxy/{url_64}.");
                case "body-is-null":
                    throw new errors.PipedreamError({
                        statusCode: _response.error.statusCode,
                        rawResponse: _response.rawResponse,
    ...
    __put(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.PipedreamTimeoutError("Timeout exceeded when calling PUT /v1/connect/{project_id}/proxy/{url_64}.");
                case "body-is-null":
                    throw new errors.PipedreamError({
                        statusCode: _response.error.statusCode,
                        rawResponse: _response.rawResponse,
    ...
    __delete(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.PipedreamTimeoutError("Timeout exceeded when calling DELETE /v1/connect/{project_id}/proxy/{url_64}.");
                case "body-is-null":
                    throw new errors.PipedreamError({
                        statusCode: _response.error.statusCode,
                        rawResponse: _response.rawResponse,
    ...
    __patch(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.PipedreamTimeoutError("Timeout exceeded when calling PATCH /v1/connect/{project_id}/proxy/{url_64}.");
                case "body-is-null":
                    throw new errors.PipedreamError({
                        statusCode: _response.error.statusCode,
                        rawResponse: _response.rawResponse,
 ...
 */
ProxyClient.JSON_ACCEPT_REGEX = /(?:^|,|\s)application\/json(?:\s*;|\s*,|\s*$)/i;
/**
 ...
 */
ProxyClient.JSON_CONTENT_TYPE_REGEX = /^application\/json(?:\s|;|$)/i;
