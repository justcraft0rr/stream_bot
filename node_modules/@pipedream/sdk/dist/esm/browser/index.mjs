...
import { ConnectTokenProvider } from "../core/auth/index.mjs";
import { PipedreamClient as BackendClient, } from "../index.mjs";
 ...
 */
export function createFrontendClient(opts) {
    const { 
    ...
    externalUserId = "", token = "", tokenCallback = () => Promise.resolve({ token, expiresAt: new Date(), connectLinkUrl: "" }), } = opts || {};
    return new PipedreamClient(Object.assign(Object.assign({}, opts), { externalUserId,
        tokenCallback }));
}
/**
...
export class PipedreamClient extends BackendClient {
    ...
    get externalUserId() {
        return this._tokenProvider.externalUserId;
    }
    /**
            ...
            const onMessage = (e) => {
                ...
                switch ((_a = e.data) === null || _a === void 0 ? void 0 : _a.type) {
                    case "success":
                        ...
                        (_b = opts.onSuccess) === null || _b === void 0 ? void 0 : _b.call(opts, {
                            id: (_c = e.data) === null || _c === void 0 ? void 0 : _c.authProvisionId,
                        });
                        break;
                    case "error":
                        connectionCompleted = true;
                    ...
                    case "close":
                        ...
                        (_e = opts.onClose) === null || _e === void 0 ? void 0 : _e.call(opts, {
    ...
    createIframe(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const token = opts.token || (yield this._tokenProvider.getToken());
